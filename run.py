...
output_file_FLAIR_name = 'subject' + '_pgs_FLAIR_' + analysis_id + '.nii.gz'
output_file_T1_name = 'subject' + '_pgs_T1_' + analysis_id + '.nii.gz'
...
for fname in os.listdir('/flywheel/v0/input'):
 ...
 # Commands
os.system("sh /WMHs_segmentation_PGS.sh T1.nii.gz FLAIR.nii.gz result.nii.gz")
